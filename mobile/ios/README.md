...
```bash
# 下载代码
mkdir -p ~/go/src/github.com/FISCO-BCOS && cd ~/go/src/github.com/FISCO-BCOS && git clone https://github.com/iavl/fisco-go-sdk.git && cd go-sdk
# 切换到develop分支
...
```bash
# 编译iOS SDK，当前目录~/go/src/github.com/iavl/fisco-go-sdk
...
```bash
# 当前目录~/go/src/github.com/iavl/fisco-go-sdk
...
```bash
# 当前目录~/go/src/github.com/iavl/fisco-go-sdk/helloworld
# 下载编译器
...
```bash
# 当前位置 ~/go/src/github.com/iavl/fisco-go-sdk/helloworld
